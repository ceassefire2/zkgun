      ...
      <div id="contact" className="relative">
        ...
        <div id="community" className="max-w-[1400px] mx-auto px-4 md:px-5 py-[30px] md:py-16 xl:py-20">
          <img data-aos="flip-left"
            ...
            alt="zklogo"
          />
          <h2 data-aos="fade-up" data-aos-delay="800" className="max-w-[855px] custom-2xs:text-4xl uppercase mx-auto text-white text-center pt-6 font_actay_wide font-medium text-custom-md sm:text-5xl md:custom-2md lg:text-7xl !leading-[100%]">
          ...
          <div data-aos="fade-zoom-in" data-aos-delay="800" className="mt-2 flex justify-center gap-[22px] sm:gap-3 w-full">
            <a rel="noreferrer"
              target="_blank"
