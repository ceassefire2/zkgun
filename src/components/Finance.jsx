        ...
        <>
            <div className="max-w-[1400px] mx-auto px-4 py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20">
                <div className="flex justify-center items-center gap-2">
                    <ClipboardData />
                    <p className='font-bold !leading-[130%] text-sm md:text-base text-white md:leading-[20.8px] font-manrope uppercase'>Fast and secure decentralized finance</p>
                </div>
                <div className="flex justify-center my-8">
                    <CommonBtn btntext="more about us" />
                </div>
                <h3 className='font_actay_wide font-medium uppercase !leading-[120%] text-center text-xl sm:text-2xl md:text-3xl xl:text-4xl lg:leading-[46.8px] text-white pt-4'>
