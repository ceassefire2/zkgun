  ...
  return (
    <>
      <span
        ...
        className={`${
          isOpen
            ? "w-full h-full absolute bg-black bg-opacity-50 top-0 start-0 z-[100]"
            : ""
        }`}
      ></span>
          ...
          <div className="flex items-start md:gap-6 lg:gap-[34px] w-full">
            ...
            >
              <div className="relative pb-10 pt-16 md:pt-10 ps-4 md:ps-0 pe-4">
                <span className="block w-[140%] h-full bg-blackPearl absolute end-0 top-0 z-0"></span>
                ...
                <div
                  onClick={() => setIsOpen(false)}
                  className="absolute inline-block top-4 end-4 cursor-pointer md:hidden"
                >
                  <LeftArrowMobile />
                </div>
                  ...
                  {documentationList.map((value, index) => {
                    return (
                      <div key={index} className="z-10 relative">
                        <p className="text-white text-lg md:text-xl !leading-[100%] font_actay_wide font-bold">
                          {value.title}
                        </p>
            ...
            <div className="md:w-[72%] lg:w-[74%] xl:w-[78%] flex flex-col items-start md:flex-row pt-6 md:pt-0">
              ...
              <div className="flex flex-col gap-8 sm:gap-10 lg:gap-[60px] pt-10">
                {documentDataList.map((value, index) => {
                  return (
                    <div key={index} className="">
                      <h4 className="text-white text-xl md:text-2xl lg:text-custom-2sm !leading-[100%] font_actay_wide font-bold">
                        {value.title}
                      </h4>
                      <p className="text-white pt-3 lg:pt-5 !leading-[130%] md:!leading-[160%] font-manrope text-sm md:text-base lg:text-lg font-normal text-opacity-70">
                        {value.description}
                      </p>
                    </div>
                  );
