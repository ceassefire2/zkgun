...
const Finance = () => {
    return (
        <>
            <div className="max-w-[1368px] mx-auto px-4 bg-[#03031b] py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20">
                ...
                <h3 className='font_over font-medium uppercase text-center text-xl sm:text-2xl md:text-3xl xl:text-4xl lg:leading-[46.8px] text-white pt-4'>
