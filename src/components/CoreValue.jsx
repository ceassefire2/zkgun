                    ...
                    {coreValueCardList.map((value, index) => {
                        return (
                            <div key={index} className={`${value.gridCenter}`}>
                                <img className='mx-auto' height={80} width={80} src={value.image} alt="core value img" />
                                <h4 className='text-white text-center pt-6 text-xl md:text-2xl font-bold font-manrope md:leading-[31.2px]'>{value.title}</h4>
                                <p className='text-white max-w-[400px] mx-auto text-center pt-2 font-manrope font-normal text-sm md:text-base md:leading-[20.8px]'>
                                    {value.description}
                                    <span className='text-white text-opacity-60'>{value.spandescription}</span>
                                </p>
                            </div>
                        )
                    })}
